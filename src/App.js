              ...
              <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",gap:10,flexWrap:"wrap"}}>
                <div>
                  <div style={{display:"flex",gap:6,marginBottom:6,flexWrap:"wrap"}}>
                    ...
                    {r.price_quoted&&<span style={{background:"#E8F5E9",color:"#2e7d32",fontSize:11,fontWeight:700,padding:"3px 9px",borderRadius:14,fontFamily:"Inter,sans-serif"}}>{r.price_quoted.toLocaleString("fr-FR")} XOF</span>}
                  </div>
